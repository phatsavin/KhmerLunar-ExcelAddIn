...
namespace KhmerLunar_ExcelAddIn
{
    public class KhmerLunar
    {
        ...
        public static Hashtable getHashMonth()
        {
            ...
            hsMonth.Add("09", "បឋមាសាឍ");
            hsMonth.Add("10", "ទុតិយាសាឍ");
            hsMonth.Add("11", "ស្រាពណ៍");
            hsMonth.Add("12", "ភទ្របទ");
            hsMonth.Add("13", "អស្សុជ");
            hsMonth.Add("14", "កត្ដិក");
        ...
        public static string getKhmerLunarString(DateTime srcDate)
        {
            ...
            khText = "ថ្ងៃ" + GetKhmerDay(srcDate) + " " + d + kr + " ខែ" + month + " ឆ្នាំ" + animalYear + " " + sak + " ព.ស." + year;
            return khText;
        }
        public static string GetKhmerFullDate(DateTime date)
        {
            ...
            string khmerDay = "ថ្ងៃទី" + ConvertToKhmerNumber(date.Day.ToString());
            string khmerMonth = "ខែ" + khmerMonths[date.Month - 1];
            string khmerYear = "ឆ្នាំ" + ConvertToKhmerNumber(date.Year.ToString());

            return  Properties.Settings.Default.Done_Setting + $" {khmerDay} {khmerMonth} {khmerYear}";
        }

        public static string ConvertToKhmerNumber(string input)
        {
            Dictionary<char, char> khmerDigits = new Dictionary<char, char>
        {
            { '0', '០' }, { '1', '១' }, { '2', '២' }, { '3', '៣' }, { '4', '៤' },
            { '5', '៥' }, { '6', '៦' }, { '7', '៧' }, { '8', '៨' }, { '9', '៩' }
        };
            ...
            {
                result.Append(khmerDigits.ContainsKey(c) ? khmerDigits[c] : c);
            }

            return result.ToString();
        }
        static string GetKhmerDay(DateTime date)
        {
            string[] khmerDays = { "អាទិត្យ", "ចន្ទ", "អង្គារ", "ពុធ", "ព្រហស្បតិ៍", "សុក្រ", "សៅរ៍" };
            return khmerDays[(int)date.DayOfWeek];
        }
